...
snapshot_download(repo_id="xinlai/LISA-13B-llama2-v0-explanatory",  allow_patterns='*.bin', local_dir='./LISA-13B-llama2-v0-explainatory', local_dir_use_symlinks=False)
